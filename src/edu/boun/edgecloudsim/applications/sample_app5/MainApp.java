...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		for (int j=SS.getMinNumOfMobileDev(); j<=SS.getMinNumOfMobileDev(); j++) 
		{
			for (int k=0; k<SS.getSimulationScenarios().length; k++)
			{
				for (int i=0; i<SS.getOrchestratorPolicies().length; i++)
				{
					...
					SimLogger.printLine("Duration: " + SS.getSimulationTime()/3600 + " hour(s) - Posisson: " + SS.getTaskLookUpTable()[0][2] + " - #devices: " + j);
